...
// Helper to parse timeline string into days
...
export default function MissionControl({ missionData, roadmap, onLogout }: MissionControlProps) {
  ...
  // Parse target days directly from user input - never rely on backend for this
                ...
                {Array.from({ length: displayDays }, (_, i) => i + 1).map((day) => {
                  ...
                  return (
                    <button
                      ...
                      className={`min-w-[4rem] h-16 rounded-xl border transition-all flex flex-col items-center justify-center relative ${
                        selectedDay === day
                    ...
                    >
                      ...
                      {/* Small dot indicator if tasks exist for that day */}
                      ...
                      <div className="flex-1">
                        {editingTaskId === task.id ? (
                          <div className="flex gap-2">
                            ...
                            />
                            <button onClick={saveEdit} className="p-1 bg-indigo-500 rounded text-white">
